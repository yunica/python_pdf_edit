...
T_HABILIT_HURBA = (
    ...
    ('C.P.', 'CENTRO POBLADO'),
    ('C.R.', 'CONJUNTO RESIDENCIAL'),
    ('CRCADO', 'CERCADO'),
    ('FUNDO', 'FUNDO'),
    ('G.R.', 'GRUPO RESIDENCIAL'),
...
T_COND_NUM_PUERT = (
    ('MUNICIPALIDAD', 'GENERADO POR MUNICIPALIDAD'),
    ('AUTOGENERADO TITULAR CATASTRAL CATASTRAL', 'AUTOGENERADO POR EL TITULAR CAT.'),
    ('GENERADO TECNICO CATASTRAL', 'GENERADO POR EL TECNICO CAT.'),
)
T_EDIFI = (
    ('BLOCK', 'BLOCK'),
...
T_FICHA = (
    ('IND', 'FICHA CATASTRAL INDIVIDUAL'),
    ('COT', 'FICHA CATASTRAL COTITULARIDAD'),
    ('ECO', 'FICHA CATASTRAL ACTIVIDAD ECONOMICA'),
    ('COM', 'FICHA CATASTRAL BIENES COMUNES'),
    ('CUL', 'FICHA CATASTRAL BIENES CULTURALES'),
    ('RUR', 'FICHA CATASTRAL RURAL'),

)

T_EST_FICHA = (
    ('COMPLETA', '(01) - FICHA COMPLETA'),
...
T_DOCUMENTO_PERSONA = (
    ('NO PRESENTO DOCUMENTO', '(01) NO PRESENTO DOCUMENTO'),
    ('DNI', '(02) DNI'),
    ('C. POLICIA NACIONAL', '(03) CARNET DE IDENTIDAD DE POLICIA NACIONAL'),
    ('C. FUERZAS ARMADAS', '(04) CARNET DE IDENTIDAD DE FUERZAS ARMADAS'),
...
T_FORMA_ADQUISICION = (
    ...
    ('APORTE', 'APORTE'),
    ('CESION DE DERECHOS DE ACCIONES', 'CESION DE DERECHOS DE ACCIONES'),
...
T_CONDICION_TITULAR = (
    ...
    ('LITIGIO', 'LITIGIO'),
    ('POSEEDOR', 'POSEEDOR'),
    ('PROPIETARIO UNICO', 'PROPIETARIO UNICO'),
    ('SOCIEDAD CONYUGAL', 'SOCIEDAD CONYUGAL'),
    ('SUCESION INTESTADA', 'SUCESION INTESTADA'),
    ('OTROS', 'OTROS'),
)
T_CONDICION_ESPECIAL_PREDIO = (
    ('MONUMENTO HISTORICO', 'MONUMENTO HISTORICO'),
    ('PREDIO RUSTICO', 'PREDIO RUSTICO'),
    ('SISTEMA DE AYUDA DE AERONAVEGACION', 'SISTEMA DE AYUDA DE AERONAVEGACION'),
)
T_ESTADO_CIVIL = (
    ('CASADO(A)', 'CASADO(A)'),
...
T_CONDICION_ESPECIAL_TITULAR = (
    ...
    ('ORGANIZACIONES SINDICALES', 'ORGANIZACIONES SINDICALES'),
    ('ORGANIZACIONES DE DISCAPACITADOS', 'ORGANIZACIONES DE DISCAPACITADOS'),
    ('PENSIONISTA', 'PENSIONISTA'),
)

t_uso_predio_catastral = (
    ('10101	', 'CASA HABITACIÓN'),
    ('10201	', 'EDIFICIO'),
    ('10202	', 'QUINTA'),
    ('10203	', 'CALLEJÓN'),
    ('10204	', 'CORRALÓN'),
    ...
    ('20102	', 'PRODUCTOS DE SILVICULTURA'),
    ('20103	', 'PRODUCTOS MANUFACTURADOS PREDOMINANTEMENTE DE CONSUMO INMEDIATO.'),
    ('20104	', 'PRODUCTOS MANUFACTURADOS DE USO DURADERO.'),
    ('20105	', 'PRODUCTOS MANUFACTURADOS PREDOMINANTEMENTE DE INSUMOS'),
    ('20106	', 'PRODUCTOS MANUFACTURADOS PREDOMINANTEMENTE DE BIENES DE CAPITAL.'),
    ('20107	', 'DE BIENES NO ESPECIFICADOS.'),
    ('20201	', 'PRODUCTOS AGROPECUARIOS Y PESQUEROS NO INDUSTRIALIZADOS.'),
    ('20202	', 'PRODUCTOS DE SILVICULTURA'),
    ('20203	', 'PRODUCTOS MANUFACTURADOS PREDOMINANTEMENTE DE CONSUMO INMEDIATO.'),
    ('20204	', 'PRODUCTOS MANUFACTURADOS DE USO DURADERO.'),
    ('20205	', 'PRODUCTOS MANUFACTURADOS PREDOMINANTEMENTE DE INSUMOS'),
    ('20206	', 'PRODUCTOS MANUFACTURADOS PREDOMINANTEMENTE DE BIENES DE CAPITAL.'),
    ('20207	', 'EQUIPAMIENTO DE COMERCIO AMBULATORIO.'),
    ('20208	', 'DE BIENES NO ESPECIFICADOS'),
    ('20301	', 'DE PRODUCTOS AGRÍCOLAS COMESTIBLES'),
    ('20302	', 'DE PRODUCTOS AGRÍCOLAS NO UTILIZADOS EN LA ALIMENTACIÓN HUMANA'),
    ('20303	', 'DE ANIMALES GENERALMENTE NO UTILIZADOS EN LA ALIMENTACIÓN HUMANA'),
    ('20304	', 'DE ANIMALES GENERALMENTE UTILIZADOS EN LA ALIMENTACIÓN HUMANA'),
    ...
    ('20311	', 'DE COMBUSTIBLES Y LUBRICANTES'),
    ('20312	', 'DE TELAS'),
    ('20313	', 'DE ARTÍCULOS DEL HOGAR'),
    ('20314	', 'DE LIBROS'),
    ('20315	', 'DE ARTÍCULOS ARTÍSTICOS Y DE LUJO'),
    ('20316	', 'DE AUTOMÓVILES Y OTROS MEDIOS DE TRANSPORTE Y TRACCIÓN PERSONAL'),
    ('20317	', 'DE DIVERSOS ARTÍCULOS DE USO DURADERO'),
    ('20318	', 'DE FERTILIZANTES'),
    ('20319	', 'DE INSUMOS MANUFACTURADOS PARA LA INDUSTRIA DE TRANSFORMACIÓN'),
    ('20320	', 'DE INSUMOS MANUFACTURADOS'),
    ('20321	', 'DE REPUESTOS Y ACCESORIOS'),
    ('20322	', 'DE MAQUINARIAS'),
    ('20323	', 'DE APARATOS DE MEDICIÓN'),
    ('20324	', 'DE VEHÍCULOS'),
    ...
    ('20402	', 'DE PROFESIÓN MÉDICA'),
    ('20403	', 'ESTUDIOS JURÍDICOS'),
    ('20404	', 'ASESORES Y CONSULTORES'),
    ('20405	', 'DE ENFERMERÍA'),
    ('20406	', 'DE CORRETAJE Y AFINES'),
    ('20407	', 'DE CONSTRUCCIÓN.'),
    ...
    ('20514	', 'DE VETERINARIA.'),
    ('20515	', 'AGENCIAS DE TURISMO'),
    ('20516	', 'DE CABALLERIZA.'),
    ('20517	', 'DE ESPARCIMIENTO NO ESPECIFICADO.'),
    ('30101	', 'AGRICULTURA'),
    ('30102	', 'EXPLOTACIÓN DE MINAS'),
    ('30201	', 'PRODUCTOS ALIMENTICIOS'),
    ('30202	', 'TEXTILES'),
    ('30203	', 'INDUSTRIA DE LA MADERA Y PRODUCTOS DE LA MADERA INCLUIDOS MUEBLES.'),
    ('30204	', 'FABRICACIÓN DEL PAPEL Y PRODUCTOS DEL PAPEL'),
    ('30205	', 'FABRICACIÓN DE SUSTANCIAS Y PRODUCTOS QUÍMICOS DERIVADOS DEL PETRÓLEO'),
    ('30206	', 'FABRICACIÓN DE PRODUCTOS MINERALES NO METÁLICOS EXCEPTO LOS DERIVADOS DEL PETRÓLEO Y CARBÓN.'),
    ...
    ('40101	', 'PARQUE METROPOLITANO.'),
    ('40102	', 'PARQUE ZONAL.'),
    ('40103	', 'PARQUE.'),
    ('40104	', 'ESTADIO.'),
    ('40105	', 'HIPÓDROMO'),
    ('40106	', 'COLISEO.'),
    ('40107	', 'CLUB O CÍRCULO.'),
    ('40108	', 'CENTRO DEPORTIVO.'),
    ('40109	', 'PISTA DE PATINAJE.'),
    ('40110	', 'CANCHA DE BOWLING.'),
    ('40111	', 'MESA DE BILLAR Y BILLAS.'),
    ('40112	', 'CANCHA DE BOCHAS'),
    ('40113	', 'GIMNASIO'),
    ('40114	', 'GALERÍA DE TIRO.'),
    ('40115	', 'PISCINA DE NATACIÓN.'),
    ('40116	', 'ACADEMIA DE DANZA'),
    ('40117	', 'ACADEMIA DE DEPORTES'),
    ('40118	', 'ACADEMIA DE ARTES MARCIALES'),
    ('40119	', 'PLAZOLETA'),
    ('40201	', 'MUSEO.'),
    ('40202	', 'CENTRO DE CONVENCIONES.'),
    ('40203	', 'SALA DE EXPOSICIÓN'),
    ('40204	', 'MONUMENTO ARQUEOLÓGICO PREHISPÁNICO/HISTÓRICO COLONIAL- REPUBLICANO.'),
    ('40205	', 'TEATRO'),
    ('40206	', 'JARDÍN BOTÁNICO.'),
    ('40207	', 'ZOOLÓGICO.'),
    ('40208	', 'CINE.'),
    ('40209	', 'BIBLIOTECA.'),
    ('40210	', 'OBSERVATORIO'),
    ('40301	', 'DISCOTECA.'),
    ('40302	', 'BINGO'),
    ('40303	', 'PINBALL O SIMILAR.'),
    ('40304	', 'PEÑA.'),
    ('40305	', 'CAFÉ TEATRO'),
    ('40306	', 'SALÓN DE BAILE.'),
    ('40307	', 'CENTRO DE APUESTA'),
    ('40308	', 'CASA DE CITA Y PROSTÍBULO'),
    ('40309	', 'CIRCO'),
    ('40310	', 'KARAOKE'),
    ('50101	', 'EDUCACIÓN INICIAL ESTATAL'),
    ...
    ('50115	', 'EDUCACIÓN ESPECIAL'),
    ('50116	', 'OTRO NO ESPECIFICADO'),
    ('50201	', 'HOSPITAL ESPECIALIZADO'),
    ('50202	', 'HOSPITAL GENERAL'),
    ('50203	', 'HOSPITAL GENERAL DE LAS FUERZAS ARMADAS Y POLICIALES'),
    ('50204	', 'CLÍNICA ESPECIALIZADA'),
    ('50205	', 'CLÍNICA'),
    ('50206	', 'CENTRO DE SALUD TIPO C'),
    ('50207	', 'PUESTO SANITARIO'),
    ('50208	', 'CENTRO ESPECIALIZADO DE ASISTENCIA SOCIAL'),
    ('50209	', 'CEMENTERIO'),
    ('50210	', 'FUNERARIA'),
    ('50301	', 'TERMINAL MARÍTIMO'),
    ('50302	', 'TERMINAL AÉREO'),
    ('50303	', 'TERMINAL TERRESTRE'),
    ('50304	', 'TERMINAL FERROVIARIO'),
    ('50305	', 'DEPÓSITO Y ALMACENAMIENTO'),
    ('50306	', 'PLAYA'),
    ('50307	', 'SERVICIO RELACIONADO AL TRANSPORTE FERROVIARIO'),
    ('50308	', 'SERVICIO RELACIONADO AL TRANSPORTE TERRESTRE INTERPROVINCIAL'),
    ('50309	', 'SERVICIO RELACIONADO AL TRANSPORTE DE CARGA POR CARRETERA'),
    ('50310	', 'OTROS SERVICIOS DE TRANSPORTE TERRESTRE DE PASAJEROS EN LA CIUDAD'),
    ...
    ('50410	', 'TELEFOTO'),
    ('50411	', 'PRENSA'),
    ('50412	', 'AGENCIA DE PRENSA'),
    ('50413	', 'AGENCIA NOTICIOSA'),
    ('50414	', 'MENSAJERÍA'),
    ('50415	', 'INTERNET'),
    ('50416	', 'OTRO NO ESPECIFICADO'),
    ('50501	', 'LUZ Y FUERZA ELÉCTRICA'),
    ('50502	', 'PRODUCCIÓN Y DISTRIBUCIÓN DE GAS'),
    ('50503	', 'SUMINISTRO DE VAPOR'),
    ('50504	', 'CENTRO DE CAPTACIÓN'),
    ('50505	', 'CENTRAL DE GENERACIÓN ELÉCTRICA'),
    ('50506	', 'SUB ESTACIÓN DE TELECOMUNICACIONES'),
    ('50601	', 'MERCADOS'),
    ('50602	', 'MERCADO AMBULATORIO'),
    ...
    ('60208	', 'CUARTEL DE LA MARINA O BASE NAVAL'),
    ('60209	', 'CENTRO DE REHABILITACIÓN Y ASISTENCIA SOCIAL (C.R.A.S.- CÁRCELES).'),
    ('60301	', 'FINANCIERA'),
    ('60302	', 'BOLSA DE VALORES'),
    ...
    ('60307	', 'BANCO COMERCIAL'),
    ('60308	', 'AGENCIA BANCARIA'),
    ('60309	', 'CAJA DE AHORRO'),
    ('60310	', 'MUTUAL'),
    ('60311	', 'COOPERATIVA DE CRÉDITO'),
    ('60312	', 'CASA DE PRÉSTAMO'),
    ...
    ('60502	', 'CONSULADO'),
    ('60503	', 'LEGACIÓN'),
    ('60504	', 'ORGANISMO INTERNACIONAL'),
    ('60601	', 'CATEDRAL'),
    ('60602	', 'PARROQUIA'),
    ('60603	', 'CAPILLA'),
    ('60604	', 'TEMPLO DE LA IGLESIA ADVENTISTA'),
    ...
    ('60608	', 'TEMPLO DE LA IGLESIA EVANGÉLICA'),
    ('60609	', 'TEMPLO DE LA IGLESIA DE JESUCRISTO DE LOS SANTOS DE LOS ÚLTIMOS DÍAS'),
    ('60610	', 'CONVENTO'),
    ('60611	', 'SALA DE REUNIÓN DEPENDIENTE DE LA ENTIDAD RELIGIOSA'),
    ('60612	', 'TEMPLO TESTIGO DE JEHOVÁ'),
    ('60701	', 'HOSPICIO'),
    ('60702	', 'ALBERGUE.'),
    ('60703	', 'PUERICULTORIO'),
    ('60704	', 'ASILO'),
    ('60705	', 'COMPAÑÍA DE BOMBEROS'),
    ('60706	', 'COMEDOR POPULAR'),
    ('60707	', 'LOCAL COMUNAL'),
    ('60708	', 'GUARDERÍA'),
    ('60801	', 'CULTURAL'),
    ('60802	', 'RELIGIOSA'),
    ...
    ('100104', '	CORRALON'),
    ('100105', '	SOLAR'),
    ('100106', '	CASA HABITACION'),
    ('100201', '	CENTRO COMERCIAL'),
    ('100202', '	GALERIA'),
    ('100203', '	OFICINA'),
    ('100204', '	OTRO NO ESPECIFICADO'),
    ('100205', '	MERCADO'),
    ('100301', '	INDUSTRIA'),
    ('100401', '	RESIDENCIAL'),
    ('100402', '	COMERCIAL'),
...
T_CONDICION_DECLARANTE = (
    ('TITULAR CATASTRAL', '(01) TITULAR CATASTRAL'),
...
T_UCA = (
    ('RETIRO MUNICIPAL', 'RETIRO MUNICIPAL'),
    ...
    ('PARQUE', 'PARQUE'),
    ('BIEN COMUN', 'BIEN COMUN'),
    ('ZONA DE RIESGO', 'ZONA DE RIESGO'),
)

T_DOCCUMENTO_ADJUNTO = (
    ('CONFORMIDAD DE OBRA', '(01) CONFORMIDAD DE OBRA'),
    ('LICENCIA DE CONSTRUCCION', '(02) LICENCIA DE CONSTRUCCION'),
    ('DECLARATORIA DE FABRICA', '(03) DECLARATORIA DE FABRICA'),
    ('ULTIMA DECLARACION JURADA AUTOAVALUO', '(04) ULTIMA DECLARACION JURADA AUTOAVALUO'),
    ('RESOLUCION DE EXONERACION', '(05) RESOLUCION DE EXONERACION'),
    ('PODERES', '(06) PODERES'),
    ('DOCUMENTO DE TRANSFERENCIA', '(07) DOCUMENTO DE TRANSFERENCIA'),
    ('CONSTANCIA DE POSESION', '(08) CONSTANCIA DE POSESION'),
    ('PARTIDA DE DEFUNCION', '(09) PARTIDA DE DEFUNCION'),
    ('CERTIFICADO CATASTRAL', '(10) CERTIFICADO CATASTRAL'),
    ('HOJA INFORMATIVA CATASTRAL', '(11) HOJA INFORMATIVA CATASTRAL'),
    ('PARTIDA DE NACIMIENTO', '(12) PARTIDA DE NACIMIENTO'),
    ('TITULO', '(13) TITULO'),
    ('COMPRA - VENTA', '(14) COMPRA - VENTA'),
    ('AUTORIZACION DE FUNCIONAMIENTO', '(15) AUTORIZACION DE FUNCIONAMIENTO'),
)
...
T_CODIGO_DECLARACION_FABRICA = (
    ('FABRICA INSCRITA', '(01) FABRICA INSCRITA'),
    ('FABRICA NO INSCRITA', '(02) FABRICA NO INSCRITA'),
)
...
Tipo_ClasificacionEdificacionn = (
    ('0100  ', 'CASA HABITACION'),
    ('0200 ', 'TIENDA / DEPOSITO / ALMACEN'),
    ('0300  ', 'PREDIO EN EDIFICIO'),
    ('0401 ', 'CLINICA'),
    ('0410', 'CEMENTERIO'),
    ('0411', 'SUB ESTACION'),
    ('0412', 'BANCO FINANCIERA'),
    ('0413', 'TERMINAL DE TRANSPORTE'),
    ('0414', 'MERCADO'),
    ('0415', 'CLUB SOCIAL'),
    ('0416', 'CLUB DE ESPARCIMIENTO'),
    ('0417', 'PLAYA DE ESTACIONAMIENTO'),
    ('0402 ', 'HOSPITAL'),
    ('0403 ', 'CINE / TEATRO'),
    ('0404 ', 'INDUSTRIA'),
    ('0405 ', 'TALLER'),
    ('0406 ', 'IGLESIA / TEMPLO'),
    ('0407 ', 'CENTRO DE ENSEÃANZA'),
    ('0408 ', 'SERVICIO DE COMIDA'),
    ('0409 ', 'PARQUE'),
    ('0500  ', 'TERRENO SIN CONSTRUIR'),
    ('999', '(419) -OTRO-'),
)

Tipo_TipoObraComplementaria = (
    ("01", 'TANQUE ELEVADO                   ', 'CONCRETO                         ', 'M3'),
    ("02", 'TANQUE ELEVADO                   ', 'LADRILLO                         ', 'M3'),
    ("03", 'TANQUE ELEVADO                   ', 'ASBESTO / PLASTICO / FIBRA DE VIDRIO              ', 'M3'),
    ("04", 'TANQUE PARA COMBUSTIBLE          ', 'CONCRETO                         ', 'GALONES'),
    ("05", 'CISTERNA                         ', 'CONCRETO                         ', 'M3'),
    ("06", 'PISCINA                          ', 'CONCRETO  ARMADO CON MAYOLICA    ', 'M3'),
    ("07", 'PISCINA                          ', 'LADRILLO KING KONG CON PINTURA   ', 'M3'),
    ("08", 'ESPEJO DE AGUA                   ', 'CONCRETO                         ', 'M3'),
    ("09", 'POZO TUBULAR HASTA 100 M. DE PROFUNDIDAD          ', '                                 ', 'UNIDAD'),
    ("10", 'POZO TUBULAR HASTA 150 M. DE PROFUNDIDAD          ', '                                 ', 'UNIDAD'),
    ("11", 'POZO TUBULAR HASTA 200 M. DE PROFUNDIDAD          ', '                                 ', 'UNIDAD'),
    ("12", 'TRIBUNA                          ', 'CONCRETO                         ', 'M2'),
    ("13", 'RAMPA                            ', 'CONCRETO                         ', 'M2'),
    ("14", 'PAVIMENTO                        ', 'CONCRETO                         ', 'M2'),
    ("15", 'PAVIMENTO                        ', 'ASFALTO                          ', 'M2'),
    ("16", 'AREA LIBRE CON PISO DE MARMOL    ', 'MARMOL                           ', 'M2'),
    ("17", 'AREA LIBRE CON PISO DE CERAMICA  ', 'CERAMICO                         ', 'M2'),
    ("18", 'AREA LIBRE CON PISO DE LOSETA    ', 'LOSETA                           ', 'M2'),
    ("19", 'AREA LIBRE CON PISO DE CEMENTO PULIDO             ', 'CEMENTO                          ', 'M2'),
    ...
    ("26", 'MURO DE CONTENCIÓN               ', 'CONCRETO                         ', 'M2'),
...
notarias_list = (
    ('ALCA CHUCHON  FILEMON         ', '                   AYACUCHO', '               AYACUCHO', 'CANGALLO', 'CANGALLO',
     'JR. TARAPACÁ S/N', '-----------', 'tula_27_06@hotmail.com'),
    ('ALMONACID CISNEROS  MARIO MARCIAL', 'AYACUCHO', 'AYACUCHO', 'HUAMANGA', 'AYACUCHO', 'JR. AREQUIPA N° 162',
     '(066) 31-3990', 'ana_yasir23@hotmail.com'),
    ('ALVIZ MONTAÑEZ  REYNALDO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'CUSCO', 'CALLE SAN ANDRÉS N° 282',
     '(084) 23-3312', 'notariaalviz@hotmail.com'),
    ('AMAO RODAS  LADISLAO', 'AYACUCHO', 'AYACUCHO', 'HUANTA', 'HUANTA', 'JR. CORDOVA N° 156 (PARQUE CENTRAL)',
     '(066) 32-1167', 'amaorodas@hotmail.com'),
    ('AVENDAÑO GARCIA  NESTOR FRANCISCO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'CUSCO', 'CALLE AYACUCHO N° 200',
     '(084) 22-5194', 'nag.notarioabogado@gmail.com.pe'),
    ('BELTRÁN PACHECO  FIDEL ORESTES', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'LA CONVENCIÓN', 'SANTA ANA',
     'PROLONGACIÓN AV. GENERAL GAMARRA S/N FRENTE A LA UNIVERSIDAD ANDINA - QUILLABAMBA', '084-613379',
     'notariabeltran@hotmail.com'),
    ('BETALLELUZ BETALLELUZ  SAMY IBETT', 'AYACUCHO', 'AYACUCHO', 'HUANTA', 'HUANTA', 'JR. MILLER N° 114',
     '(066) 32-2534', 'notariabetalleluz@hotmail.com'),
    ('BUSTAMANTE ARAGON  JORGE OSWALDO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'CUSCO',
     'CAL. PAMPA DEL CASTILLO N° 460 (459)', '(084) 25-8072 / (084)23-1665', 'notariabustamante@hotmail.com'),
    ('CENTELLAS MACHACA  OLGER', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'QUISPICANCHI', 'URCOS',
     'JR. MARIANO MELGAR NRO. 113', '(084) 30-7259', 'ollgercentellas@hotmail.com'),
    (
        'CHILLCCE JAYO  MIGUEL ANGEL', 'AYACUCHO', 'AYACUCHO', 'HUANTA', 'HUANTA', 'AV. SAN MARTIN N° 220',
        '(066) 40-2986',
        'miguelchillcce@hotmail.com'),
    ('CUBA CASTRO  ALFREDO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'LA CONVENCIÓN', 'SANTA ANA', 'JR. LIBERTAD N° 611',
     '(084) 28-1077', 'alfcubacastro@hotmail.com'),
    ('DE LOS RIOS GUZMAN DE CARCAUSTO  BLANCA MARIA', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'SANTIAGO',
     'AV. GRAU N° 949B', '(084) 25-3441', 'notariadelosrios_guzman@hotmail.com'),
    ('DELGADO ESCOBEDO   MARTHA BEATRIZ ALEXANDRA', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'SAN JERONIMO',
     'MZA. L LOTE. 23-B URB. VERSALLES', '(084) 27-1717', 'marthadenot@hotmail.com'),
    ('FIGUEROA CAMACHO  EDIE', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CALCA', 'PISAC', 'AV. AMAZONAS N° 101 - PISAC',
     '(084) 20-3288', 'notariafigueroa@hotmail.com'),
    ('GALDO SOTOMAYOR  MARIA EUGENIA', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'QUISPICANCHI', 'URCOS',
     'JR. BELAUNDE TERRY N° 176 - PLAZA DE ARMAS DE  URCOS', '(084) 30-7088 / (084) 50-9689',
     'notariagaldos@hotmail.com'),
    ('GAONA CHACÓN  OSWALDO RUFFO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'ESPINAR', 'ESPINAR',
     'CAL. TEATRO N° 207 - ESPINAR', '(084) 30-1358', 'ogaona@notariagaona.com'),
    ('GAONA CISNEROS  RUFFO HERMOGENES', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'CUSCO', 'SAN ANDRES N° 238',
     '(084) 22-4937/ (084)23-6923', 'maria.ganoa@mariaganoa.com'),
    ('GARCÍA MEDINA  LOURDES MADELEINE', 'CUSCO Y MADRE DE DIOS', 'MADRE DE DIOS', 'TAMBOPATA', 'TAMBOPATA',
     'JR. PUNO N° 716 PUERTO MALDONADO', '(082) 50-2258', 'notarialourdesga@hotmail.com'),
    ('GIRON ARANA  CESAR ODON', 'AYACUCHO', 'AYACUCHO', 'HUANTA', 'HUANTA', 'JR. GERVASIO SANTILLANA N° 202',
     '(066) 32-2198 / (066) 32-2215', 'notariogiron@terra.com'),
    ('HINOSTROZA AUCASIME  JOSE', 'AYACUCHO', 'AYACUCHO', 'HUAMANGA', 'AYACUCHO', 'JR. BELLIDO N° 609', '(066) 32-7407',
     'jhinostroza10@hotmail.com'),
    ('HOLGADO NOA DE CACERES  LISBETH', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'SANTIAGO',
     'MZA. B-3 LOTE. A - URB. BANCOPATA', '(084) 26-0615', 'lisbeth.holgado@hotmail.com'),
    ('HUANCA CAYLLAHUA  TORIBIO MARCIAL', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'ANTA', 'ANTA',
     'JR. JAQUIJAHUANA MZA. C-6 LOTE. 10 INT. 201 CENTRO POBLADO IZCUCHACA', '(084) 20-3677', 'huanca1236@hotmail.com'),
    ('JORDAN GAMARRA  YORKA INES', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'ANTA', 'ANTA',
     'JR. JAQUIJAHUANA N° 513- IZCUCHACA', '(084) 43-4012', 'notariajordangamarra@hotmail.com'),
    ('LIRA APAZA  LUIS ALBERTO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'SAN SEBASTIAN',
     'PROLG. AV LA CULTURA MZA. O-12-B (ENTRE EL PARADERO CAMIONERO Y PARADERO SANTA ROSA)', '(084) 27-6890',
     'luis_lira@hotmail.com'),
    ('MACHACA  CALLE  SEVERO', 'AYACUCHO', 'AYACUCHO', 'LA MAR', 'AYNA', 'AV. 28 DE JULIO N°  49', '(066)31-2015',
     'severomachaca@hotmail.com'),
    ('MACHACA CALLE  GUDELIA', 'AYACUCHO', 'AYACUCHO', 'HUAMANGA', 'AYACUCHO', 'AV. GARCILASO DE LA VEGA N° 241',
     '(066) 31-1359', 'notariamachacacalle@hotmail.com'),
    ('MAMANI ASLLA  ANACLETO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CHUMBIVILCAS', 'SANTO TOMAS', 'CAL. SIGLO XX N° 511',
     '(084) 830421', '-'),
    ('MEDINA DELGADO  VÍCTOR ELÍAS', 'AYACUCHO', 'AYACUCHO', 'HUAMANGA', 'JESUS NAZARENO', 'JR. CIRO ALEGRIA N° 341',
     '(066) 32-7081', 'notariovictormedina@hotmail.com'),
    ('MENDOZA AZPARRENT  DALMACIO DARÍO', 'AYACUCHO', 'AYACUCHO', 'HUAMANGA', 'AYACUCHO', 'JR. CUSCO N° 260',
     '(066) 31-4130', 'mazparrent260@hotmail.com'),
    ('MUÑIZ ESCOBAR  ABEL', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'LA CONVENCIÓN', 'SANTA ANA', 'JR. ESPINAR N° 353',
     '(084) 28-1134', 'abelmuñiz@terra.com.pe'),
    ('NEGRÓN PERALTA  RODZANA', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'SAN SEBASTIAN',
     'PROL. AV DE LA CULTURA N° 1108', '(084) 27-3351', 'negronperalta@no.com pe'),
    ('OCAMPO DELAHAZA  LUCILA ANTONIETA', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'CUSCO',
     'AV. EL SOL N° 616  INTERIOR 5  PASAJE GRACE', '(084) 22-8711', 'ocampodelahaza@hotmail.com'),
    ('OCHOA ALVAREZ  GUIDO EDUARDO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'URUBAMBA', 'URUBAMBA', 'CAL. COMERCIO N° 211',
     '(084) 20-1078', '-'),
    ('OLAGUIBEL OLIVERA   GIL ABAD', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'URUBAMBA', 'URUBAMBA', 'JR. YUPANQUI N° 115',
     '(084) 20-1670 / (084) 80-0790', 'abperuado1@hotmail.com'),
    ('OLIVERA UMERES  JOHN', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CHUMBIVILCAS', 'SANTO TOMAS',
     'CALLE PROGRESO N° 100-A SANTO TOMAS', '-----------', 'notariaolivera@hotmail.com'),
    ('ORE GAMBOA  CARLOS PELAYO', 'AYACUCHO', 'AYACUCHO', 'HUAMANGA', 'SAN JUAN BAUTISTA', 'AV. SAN LORENZO N° 490',
     '(066) 32-7081', 'notariaoregamboa@gmail.com'),
    ('OROS CARRASCO  RODOLFO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'WANCHAQ', 'AV. HUASCAR N° 219B',
     '(084) 23-5388', 'notaria.oroscarrasco@gmail.com'),
    ('OSORIO ALVARADO  HONORATO ZENON', 'AYACUCHO', 'AYACUCHO', 'HUANTA', 'SIVIA', 'AV. HUANTA N° 138', '(066) 79-2948',
     'notariasivia@hotmail.com'),
    ('PACHECO MERCADO  ORLANDO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'CUSCO', 'AV. GRAU N° 438', '(084) 23-7891',
     'notaria_pacheco@hotmail.com'),
    ('PALOMINO MANTILLA  LUIS FERNANDO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'PARURO', 'PARURO',
     'PLAZA. PLAZA DE ARMAS S/N', '(084) 27-3433', 'notariapalominomantillalf@hotmail.com'),
    ('PANTIGOSO HERRERA  JUAN MANUEL', 'CUSCO Y MADRE DE DIOS', 'MADRE DE DIOS', 'TAMBOPATA', 'TAMBOPATA',
     'AV. LEON VELARDE N° 727', '(082) 57-4064 / (082) 57-1445', '-'),
    ('POZO UGARTE   ABEL SALUSTIO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'LA CONVENCIÓN', 'QUELLOUNO',
     'JR. QUILLABAMBA N° 205 PLAZA DE ARMAS', '-----------', 'abelpozougarte@hotmail.com'),
    ('PRADO CALDERON  JOSE LUIS', 'AYACUCHO', 'AYACUCHO', 'HUAMANGA', 'SAN JUAN BAUTISTA', 'AV. RAMON CASTILLA N° 184',
     '(066) 32-6646', 'notaprado@hotmail.com'),
    ('REMON BUITRON  ALIPIO', 'AYACUCHO', 'AYACUCHO', 'HUAMANGA', 'AYACUCHO', 'JR. SAN MARTIN N° 452', '(066) 31-3056',
     '----------'),
    ('RODRÍGUEZ GIL  CESAR LADISLAO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'ACOMAYO', 'ACOMAYO', 'JR. SUCRE N° 100',
     '(084) 83-0075', 'crodriguez@notarios.org.pe'),
    ('RUEDA ALVAREZ  JOSÉ FERNANDO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'PAUCARTAMBO', 'PAUCARTAMBO',
     'CAL. MARCAVALLE N° 204 - URB. PAUCARTAMBO', '-----------', 'jruedaalvarez@yahoo.es'),
    ('RíOS PICKMANN   GAVIN ALFREDO', 'CUSCO Y MADRE DE DIOS', 'MADRE DE DIOS', 'TAMBOPATA', 'TAMBOPATA',
     'AV. LEON VELARDE N° 765 - TAMBOPATA', '(082) 57-1116', 'notarioriospickmann@yahoo.com'),
    ('SALAZAR PUENTE DE LA VEGA  MERCEDES', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'WANCHAQ',
     'AV. HUAYNA CCAPAC N° 113 INT. A', '(084) 22-1039 / (084) 22-8597', 'mechispv@gmail.com / mersal63@hotmail.com'),
    ('SANCHEZ GAMARRA DE ORDOÑEZ   MERY ALINDA', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CALCA', 'CALCA',
     'CAL. CORDOVA N° 146 - CALCA', '(084) 20-2321', 'mery.a.sanchez@gmail.com'),
    ('SARAVIA PALOMINO  WILLIAM LIOV', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CALCA', 'CALCA', 'JR. BOLIVAR N° 741 - CALCA',
     '(084) 70-3729', 'liovs@hotmail.com'),
    ('SOMOCURCIO ALARCÓN  CARLOS AUGUSTO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CUSCO', 'CUSCO',
     'CALLE BELEN N° 307 - CUSCO', '(084) 24-2224', 'ca.somocurcio@terra.com.pe'),
    ('TERRAZAS GONZALES  DUNIA VICTORIA', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'ESPINAR', 'ESPINAR',
     'JIRÓN ARICA N° 119 ESPINAR', '(084) 77-9960', 'terrazasg@hotmail.com'),
    ('VENERO TAPIA  MARCO YVAN', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CANCHIS', 'MARANGANI',
     'AV. SAN MARTIN N° 826 - FRENTE DE INSTITUTO EDUCA', '(084) 79-6009', 'nelly.yv@gmail.com'),
    ('VILLANUEVA SANCHEZ  NESTOR DIONICIO', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'CANCHIS', 'SICUANI', 'JR. TACNA N° 145',
     '(084) 35-1013', 'nestornotario@hotmail.com'),
    ('VILLANUEVA SANCHEZ  URIEL', 'CUSCO Y MADRE DE DIOS', 'CUSCO', 'ESPINAR', 'ESPINAR', 'CAL. TACNA N° 104',
     '(084) 30-1218', 'uriel_villanueva@hotmail.com'),

)
T_CONDICION_CONDUCTOR = (
    ('TITULAR CATASTRAL', 'TITULAR CATASTRAL'),
...
T_DOCUMENTO_PRESENTADO_ECONOMICA = (
    ...
    ('LICENCIA DE FUNCIONAMIENTO Y ANUNCIOS', 'LICENCIA DE FUNCIONAMIENTO Y ANUNCIOS'),
)
t_anuncio = (
    ('011', 'AVISO ECOLOGICO VARIABLE'),
    ('012', 'AVISO ECOLOGICO LUMINOSO'),
    ('013', 'AVISO ECOLOGICO DE PROYECCION'),
    ('014', 'AVISO ECOLOGICO ILUMINADO'),
    ('021', 'CARTEL VARIABLE'),
    ('022', 'CARTEL LUMINOSO'),
    ('023', 'CARTEL DE PROYECCION'),
    ('024', 'CARTEL ILUMINADO'),
    ('031', 'CARTELERA VARIABLE'),
    ('032', 'CARTELERA LUMINOSO'),
    ('033', 'CARTELERA DE PROYECCION'),
    ('034', 'CARTELERA ILUMINADO'),
    ('041', 'GLOBO AEROSTATICO VARIABLE'),
    ('042', 'GLOBO AEROSTATICO LUMINOSO'),
    ('043', 'GLOBO AEROSTATICO DE PROYECCION'),
    ('044', 'GLOBO AEROSTATICO ILUMINADO'),
    ('051', 'LETRERO VARIABLE'),
    ('052', 'LETRERO LUMINOSO'),
    ('053', 'LETRERO DE PROYECCION'),
    ('054', 'LETRERO ILUMINADO'),
    ('061', 'LETRAS RECORTADAS VARIABLE'),
    ('062', 'LETRAS RECORTADAS LUMINOSO'),
    ('063', 'LETRAS RECORTADAS DE PROYECCION'),
    ('064', 'LETRAS RECORTADAS ILUMINADO'),
    ('071', 'MARQUESINA VARIABLE'),
    ('072', 'MARQUESINA LUMINOSO'),
    ('073', 'MARQUESINA DE PROYECCION'),
    ('074', 'MARQUESINA ILUMINADO'),
    ('081', 'PANEL SIMPLE VARIABLE'),
    ('082', 'PANEL SIMPLE LUMINOSO'),
    ('083', 'PANEL SIMPLE DE PROYECCION'),
    ('084', 'PANEL SIMPLE ILUMINADO'),
    ('091', 'PANEL MONUMENTAL VARIABLE'),
    ('092', 'PANEL MONUMENTAL LUMINOSO'),
    ('093', 'PANEL MONUMENTAL DE PROYECCION'),
    ('094', 'PANEL MONUMENTAL ILUMINADO'),
    ('101', 'PROYECCIONES VARIABLE'),
    ('102', 'PROYECCIONES LUMINOSO'),
    ('103', 'PROYECCIONES DE PROYECCION'),
    ...
    ('114', 'ROTULOS EN VEHICULOS ILUMINADO'),
    ('121', 'TOLDOS VARIABLE'),
    ('122', 'TOLDOS LUMINOSO'),
    ('123', 'TOLDOS DE PROYECCION'),
    ('124', 'TOLDOS ILUMINADO'),
    ('131', 'AVISO ESCULTORIO VARIABLE'),
...
t_actividad_economica = (
    ...
    ('12401', 'FABRICACIÓN DE CALZADO EXCEPTO EL DE CAUCHO VULCANIZADO O MOLDEADO DE PLÁSTICO '),
    ('13101', 'ASERRADEROS '),
    ('13102', 'FABRICACIÓN DE ENVASES DE MADERA Y DE CAÑA Y ARTÍCULOS MENUDOS DE CAÑA '),
    ...
    ('14103', 'FABRICACIÓN DE ARTÍCULOS DE PULPA '),
    ('14201', 'IMPRENTAS '),
    ('15101', 'FABRICACIÓN DE SUSTANCIAS QUÍMICAS INDUSTRIALES BÁSICAS EXCEPTO ABONOS '),
    ...
    ('15301', 'REFINERIAS DE PETROLEO '),
    ('15302', 'FABRICACIÓN DE PRODUCTOS DIVERSOS DERIVADOSDEL PETRÓLEO Y DEL CARBÓN '),
    ...
    ('18203', 'CONSTRUCCIÓN DE MAQUINARIAS PARA TRABAJAR LOS METALES Y LA MADERA '),
    ('18204', 'CONSTRUCCIÓN DE MAQUINARIA Y EQUIPOS ESPECIALES PARA LAS INDUSTRIAS '),
    ...
    ('18302', 'CONSTRUCCIÓN DE EQUIPOS Y APARATOS DE RADIO '),
    ('18303', 'CONSTRUCCIÓN DE APARATOS Y ACCESORIOS ELÉCTRICOS DE USO DOMÉSTICO '),
    ...
    ('31108', 'ACEITUNAS '),
    ('31109', 'CACAO '),
    ('31199', 'OTROS PRODUCTOS AGRÍCOLAS COMESTIBLES NO CLASIFICADOS EN OTRA PARTE '),
    ('31201', 'ALGODÓN '),
    ('31202', 'FLORERIA '),
    ('31203', 'FORRAJES '),
    ('31204', 'SEMILLAS Y PLANTAS '),
    ('31205', 'TABACO EN RAMA '),
    ('31206', 'COCA '),
    ('31207', 'YERBA SECA PARA DIFERENTES USOS '),
    ('31209', 'OTROS PRODUCTOS AGRÍCOLAS NO UTILIZADOS PARA EL CONSUMO NO CLASIFICADOS EN OTRA PARTE '),
    ('31301', 'PRODUCTOS DE LA CASA '),
    ('31302', 'PESES ORNAMENTALES '),
    ('31303', 'ANIMALES DE CARGA '),
    ('31304', 'COCHINILLA '),
    ('31305', 'ANIMALES DOMESTICOS '),
    ('31399', 'OTROS ANIMALES NO UTILIZADOS EN LA ALIMENTACIÓN Y NO CLASIFICADOS EN OTRA PARTE '),
    ('31401', 'AVICOLAS '),
    ('31402', 'CARNICERIA '),
    ('31403', 'GANADO EN PIE '),
    ('31404', 'PESCADERIAS Y AFINES '),
    ('31405', 'ANIMALES PEQUEÑOS '),
    ('31499',
     'OTROS ANIMALES VIVOS Y PRODUCTOS PECUARIOS UTILIZADOS EN LA ALIMENTACIÓN Y NO CLASIFICADOS EN LA OTRA PARTE '),
    ('32101', 'PLANTAS MEDICINALES '),
    ('32102', 'TRONCOS PARA ASERRADEROS '),
    ('32103', 'COMERCIO DE MINERALES Y METALES '),
    ('32199', 'OTROS PRODUCTOS EN ESTADO NATURAL NO CLASIFICADOS EN OTRA PARTE '),
    ('32201', 'CAUCHO '),
    ('32202', 'PRODUCTOS PROVENIENTES DEL CULTIVO Y/O EXPLOTACIÓN DE OTRAS ESPECIES VEGETALES: GERMEN DE TRIGO '),
    ('32299', 'OTROS PRODUCTOS DERIVADOS NO INDUSTRIALIZADOS '),
    ('33101', 'CAFÉ DE TOSTADURIA '),
    ('33102', 'CONFITERIA '),
    ('33103', 'EMBUTIDOS '),
    ('33104', 'HELADERIAS '),
    ('33105', 'LECHERIA Y CREMERIA '),
    ('33106', 'PANADERIA Y PASTELERIA '),
    ('33107', 'TIENDA DE ABARROTES '),
    ('33109', 'OTROS PRODUCTOS ALIMENTICIOS NO CLASIFICADOS EN OTRA PARTE '),
    ('33110', 'MINIMARKET '),
    ('33201', 'NUTRIMENTOS '),
    ('33299', 'OTROS PRODUCTOS ALIMENTICIOS PREPARADOS PARA ANIMALES NO CLASIFICADOS EN OTRA PARTE '),
    ('33301', 'LICORERIAS '),
    ('33302', 'CIGARRERIA '),
    ...
    ('33504', 'LUBRICANTES '),
    ('33505', 'RON DE QUEMAR '),
    ('33599', 'OTROS COMBUSTIBLES '),
    ('34101', 'MERCERIA '),
    ('34102', 'ZAPATERIAS '),
    ('34103', 'PELETERIAS '),
    ('34104', 'BAZAR '),
    ('34105', 'SOMBRERERIA (SOMBREROS) '),
    ('34106', 'TELAS Y TEJIDOS '),
    ('34107', 'TRAJES DE BODA Y COMPROMISOS EN GENERAL Y ACCESORIOS '),
    ('34108', 'ARTICULOS PARA EL ARREGLO PERSONAL '),
    ('34199', 'OTRAS TELAS Y TEJIDOS '),
    ('34201', 'APARATOS DOMESTICOS '),
    ('34202', 'ALFOMBRAS '),
    ('34203', 'COLCHONERÍA '),
    ('34204', 'MUEBLERIA (MUEBLES PARA EL HOGAR) '),
    ('34205', 'LENCERIA '),
    ('34206', 'LOCERIA Y CRISTALERIA '),
    ('34207', 'UTENSILIOS DE COCINA '),
    ...
    ('34302', 'REVISTAS Y PERIODICOS '),
    ('34303', 'TARJETAS '),
    ('34399', 'OTROS LIBROS '),
    ('34401', 'ARTICULOS ARTESANALES '),
    ('34402', 'ANTIGUEDADES '),
    ('34403', 'PLATERIA '),
    ('34404', 'CASA DE REGALOS '),
    ('34405', 'ARTICULOS RELIGIOSOS '),
    ('34406', 'DISFRACES Y ARTICULOS PARA FIESTAS '),
    ('34407', 'JOYERIA Y RELOJERIA '),
    ('34408', 'CUADROS Y ESCULTURAS '),
    ('34409', 'BRONCERIA '),
    ('34410', 'ARTICULOS DE FILATELIA '),
    ('34411', 'LAMPARAS '),
    ('34412', 'ARTICULOS DE FANTASIA '),
    ('34413', 'ARTICULOS DE PIROTECNIA '),
    ('34499', 'OTROS ARTÍCULOS Y DE LUJO NO CLASIFICADOS EN OTRA PARTE '),
    ('34501', 'AUTOMOVILES '),
    ('34502', 'BICICLETAS Y SIMILARES '),
    ('34503', 'MOTOCICLETAS Y MOTONETAS '),
    ('34599', 'OTROS AUTOMÓVILES Y OTROS MEDIOS DE TRANSPORTE Y TRACCIÓN PERSONAL NO CLASIFICADOS EN OTRA PARTE '),
    ('34601', 'INMUEBLES '),
    ('34699', 'OTROS BIENES RAICES NO CLASIFICADOS EN OTRA PARTE '),
    ('34702', 'ARMERIA '),
    ('34703', 'ARTICULOS DEPORTIVOS '),
    ('34704', 'CASA DE DISCOS '),
    ('34705', 'EQUIPOS FOTOGRAFICOS Y DE PROYECCION '),
    ('34706', 'INSTRUMENTOS MUSICALES '),
    ('34707', 'JUGUETERIA '),
    ('34708', 'MALETERIA '),
    ('34709', 'CASA DE REMATES '),
    ...
    ('34713', 'HOJALATERIA '),
    ('34799', 'OTROS ARTÍCULOS DIVERSOS DE USO DURADERO NO CLASIFICADOS EN OTRA PARTE '),
    ('35101', 'FERTILIZANTES Y PESTICIDAS '),
    ('35199', 'OTROS FERTILIZANTES '),
    ('35201', 'CUERO '),
    ('35202', 'CHATARRA '),
    ('35203', 'PRODUCTOS QUIMICOS INDUSTRIALES ESENCIALES '),
    ('35204', 'PAPEL Y CARBON '),
    ('35205', 'ALCOHOL HIDRATADO '),
    ('35206', 'LEVADURAS Y ESENCIAS '),
    ('35207', 'LANA '),
    ('35208', 'INSUMOS PARA LA INDUSTRIA DEL CALZADO '),
    ('35209', 'MARROQUINES '),
    ('35299', 'OTROS INSUMOS MANUFACTURADOS PARA LA INDUSTRIA DE TRANSFORMACIÓN NO CLASIFICADOS EN OTRA PARTE '),
    ('35301', 'FERRETERIA '),
    ('35302', 'CEMENTO '),
    ('35303', 'FIERRO Y ACERO EN VARILLAS '),
    ('35304', 'LADRILLOS '),
    ('35305', 'MADERAS '),
    ('35306', 'MARMOLERIA '),
    ('35307', 'PINTURAS '),
    ...
    ('35311', 'INSUMOS PARA CARPINTERÍA METÁLICA '),
    (
        '35399',
    ...
    ('36102', 'EQUIPOS PARA OFICINA '),
    ('36103', 'MUEBLES PARA OFICINA '),
    ('36104', 'MAQUINARIAS '),
    ('36105', 'MAQUINARIAS '),
    ('36106', 'MAQUINARIAS '),
    ('36107', 'MAQUINARIAS '),
    ('36199', 'OTRAS MAQUINARIAS '),
    ('36201', 'PARA COMERCIO '),
    ('36202', 'PARA INGENIERIA '),
    ('36203', 'PARA MEDICINA '),
    ('36204', 'PARA SERVICIOS '),
    ('36205', 'OTROS APARATOS DE MEDICIÓN '),
    ('36301', 'CAMIONES '),
    ('36302', 'CARGADORES '),
    ('36303', 'VEHICULOS DE TRANSPORTE ACUATICO '),
    ('36399', 'OTROS VEHÍCULOS NO CLASIFICADOS EN OTRA PARTE '),
    ('37101', 'TIENDAS DE DEPARTAMENTOS '),
    ('37102', 'CAJAS '),
    ('37103', 'BOLSAS '),
    ('37104', 'BOTELLAS '),
    ('37105', 'HIELO '),
    ...
    ('41112', 'RESTAURANTE '),
    ('41113', 'PIZZERIA '),
    ('41114', 'FUENTE DE SODA '),
    ('41115', 'SANDWICHERÍA '),
    ('41116', 'SNACK BAR '),
    ('41117', 'COMIDA AL PASO '),
    ('41199', 'OTROS SERVICIOS DE ALIMENTACIÓN Y BEBIDAS NO CLASIFICADOS EN OTRA PARTE '),
    ('41201', 'ALQUILER DE TRAJES '),
    ('41202', 'LAVANDERIA Y TINTORERIA '),
    ('41203', 'LUSTRADO DE CALZADO '),
    ('41204', 'REPARACION DE CALZADO '),
    ('41205', 'TALLER DE SOMBRERIA '),
    ('41206', 'SASTRERÍA '),
    ('41207', 'TALLER DE MODAS '),
    ('41208', 'BORDADURIA '),
    ...
    ('41301', 'ALQUILER DE INMUEBLES '),
    ('41302', 'CENTROS VACACIONALES '),
    ('41303', 'HOSTAL '),
    ('41304', 'HOSTAL RESIDENCIAL '),
    ('41305', 'HOTEL '),
    ('41306', 'HOTEL RESIDENCIAL '),
    ('41307', 'MOTELES '),
    ('41308', 'PENSION '),
    ('41309', 'MANTENIMIENTO Y LIMPIEZA DE INMUEBLES '),
    ('41310', 'OTROS SERVICIOS DE VIVIENDA Y ALOJAMIENTO NO CLASIFICADOS EN OTRA PARTE '),
    ('41401', 'BAÑOS PUBLICOS '),
    ('41402', 'PEDICURIA Y/O MANICURIA '),
    ('41403', 'PELUQUERIA '),
    ('41404', 'SALONES DE BELLEZA Y PEINADOS '),
    ('41405', 'BAÑOS SAUNA O BAÑOS TURCOS '),
    ('41406', 'GIMNASIO '),
    ('41499', 'OTROS SERVICIOS DE HIGIENE Y ESTÉTICA PERSONAL NO CLASIFICADOS EN OTRA PARTE '),
    ('41501', 'FUNERARIAS '),
    ...
    ('42103', 'FRAGMENTACION Y/O EMBAZADO '),
    ('42104', 'ROTULACION '),
    ('42105', 'FUMIGACION '),
    ('42106', 'AGENCIAS DE PUBLICACION '),
    ('42107', 'PROCESAMIENTO ELECTRONICO DE DATOS '),
    ('42108', 'ESTUDIO FOTOGRAFICO '),
    ('42109', 'DECORACIONES '),
    ('42110', 'INSTALACIONES INDUSTRIALES Y COMERCIALES '),
    ('42111', 'GALVANOPLASTIA '),
    ('42112', 'CERRAJERIA '),
    ('42113', 'TORNERIA '),
    ...
    ('43102', 'FACTORIA '),
    ('43103', 'LAVADO Y ENGRASE DE VEHÍCULOS '),
    ...
    ('43108', 'CARROCERIAS '),
    ('43109', 'TALLER DE PLANCHADO Y PINTURA '),
    ('43110', 'VULCANIZADORA Y/O REENCAUCHADORA '),
    ('43111', 'TALLER DE BATERIAS '),
    ('43112', 'REPARACION DE EMBARCACIONES PESQUERAS '),
    ('43113', 'INSTALACIÓN DE TUBOS DE ESCAPE Y AFINES '),
    ('43199', 'OTROS SERVICIOS DE MECÁNICA AUTOMOTRIZ Y AFINES NO CLASIFICADOS EN OTRA PARTE '),
    ('43201', 'TALLER DE SOLDADURA '),
    ('43202', 'TALLER DE REPARACION DE MAQUINARIA EN GENERAL '),
    ('43203', 'INSTALACIONES ELECTRICAS Y/O ELECTRONICAS '),
    ('43204', 'OTROS SERVICIOS DE MECÁNICA EN GENERAL Y ELECTRICIDAD NO CLASIFICADOS EN OTRA PARTE '),
    ...
    ('43304', 'CARPINTERIA METALICA '),
    ('43306', 'TAPICERIA '),
    ('43307', 'GASFITERIA '),
    ('43308', 'REPARACIÓN DE CATRES Y SIMILARES '),
    ('43399', 'REPARACIÓN DE OTROS APARATOS DOMÉSTICOS NO ESPECIFICADOS EN OTRA PARTE '),
    ('43401', 'TALLER DE MECANICA DE PRECISION '),
    ('43402', 'TALLER DE RELOJES '),
    ('43403', 'TALLER DE REPARACIONES DE JOYAS '),
    ('43499', 'OTROS SERVICIOS DE MECÁNICA FINA NO CLASIFICADOS EN OTRA PARTE '),
    ('44101', 'TRANSPORTE FERROVIARIO '),
    ('44102', 'TRANSPORTE URBANO '),
    ...
    ('44107', 'SILOS '),
    ('44199', 'OTROS SERVICIOS DE TRANSPORTE TERRESTRE NO ESPECIFICADOS EN OTRA PARTE '),
    ('44201', 'TRANSPORTE OCEANICO O DE CABOTAJE '),
    ('44202', 'TRANSPORTE POR VIAS DE NAVEGACION INTERIOR '),
    ('44203', 'ESTIBADORES '),
    ('44204', 'SERVICIOS RELACIONADOS CON EL TRANSPORTE DE AGUA '),
    ('44299', 'OTROS SERVICIOS DE TRANSPORTE AÉREO NO CLASIFICADOS EN OTRA PARTE '),
    ...
    ('45101', 'BANCO '),
    ('45102', 'AGENCIA BANCARIA '),
    ('45103', 'CAJA DE AHORRO '),
    ('45104', 'MUTUAL '),
    ('45105', 'COOPERATIVA DE CREDITO '),
    ('45106', 'CASA DE PRÉSTAMOS '),
    ('45199', 'OTRAS INSTITUCIONES MONETARIAS NO CLASIFICADAS EN OTRA PARTE '),
    ('45201', 'FINANCIERAS '),
    ('45202', 'BOLSA DE VALORES '),
    ('45203', 'AGENCIAS CAMBIARIAS '),
    ('45204', 'COMPAÑÍA DE PATENTES Y LICENCIAS '),
    ('45205', 'SERVICIOS FINANCIEROS '),
    ('45299', 'OTROS SERVICIOS DE ESTABLECIMIENTOS FINANCIEROS NO CLASIFICADOS EN OTRA PARTE '),
    ('45301', 'SEGUROS '),
    ('45399', 'OTROS SERVICIOS DE SEGUROS NO CLASIFICADOS EN OTRA PARTE '),
    ('45401', 'SERVICIOS JURIDICOS '),
    ('45402', 'SERVICIOS DE CONTABILIDAD '),
    ('45403', 'SERVICIOS DE ELABORACION DE DATOS Y DE TABULACION '),
    ('45404', 'SERVICIOS TECNICOS Y ARQUITECTÓNICOS '),
    ('45405', 'SERVICIOS DE PUBLICIDAD '),
    ('45406', 'AGENCIA COMISIONISTA '),
    ('45407', 'COBRANZAS Y/O MENSAJES '),
    ('45408', 'AGENCIA DE EMPLEOS '),
    ('45409', 'AGENCIAS DE TRÁMITES '),
    ('45499', 'SERVICIOS PRESTADOS A LAS EMPRESAS '),
    ('45501', 'ALQUILER Y ARRENDAMIENTO DE MAQUINARIA Y EQUIPO '),
    ('45599', 'OTROS SERVICIOS DE ALQUILER Y ARRENDAMIENTO DE MAQUINARIA Y EQUIPO NO CLASIFICADOS EN OTRA PARTE '),
    ('46101', 'SERVICIOS DE SANEAMIENTO Y SIMILARES '),
    ('46102', 'OTROS SERVICIOS DE SANEAMIENTO Y SIMILARES NO CLASIFICADOS EN OTRA PARTE '),
    ('46201', 'SERVICIOS MÉDICOS Y ODONTOLÓGICOS Y OTROS SERVICIOS DE SANIDAD '),
    ('46203', 'ASOCIACIONES COMERCIALES '),
    ('46299', 'OTROS SERVICIOS SOCIALES Y COMUNALES NO CLASIFICADOS EN OTRA PARTE '),
    ...
    ('46310', 'CENTROS NOCTURNOS '),
    ('46311', 'CABARET '),
    ('46312', 'DISCOTECA '),
    ('46313', 'BOITE '),
    ('46314', 'COLISEOS '),
    ('46315', 'SALON DE JUEGOS '),
    ('46316', 'SERVICIOS PARA FIESTAS '),
    ('46317', 'CAFÉ-TEATROS '),
    ('46318', 'PEÑA CRIOLLA '),
    ('46319', 'CASAS DE CITAS '),
    ('46320', 'PROSTIBULOS '),
    ('46322', 'ALQUILER DE VIDEOS (V.H.S.) '),
    ('46323', 'VIDEOS JUEGOS (NINTENDO) '),
    ('46324', 'VIDEO PUB '),
    ('46327', 'PUB '),
    ('46400', 'EDUCACION '),
...
T_USO_BIENES_COM = (
    ('EDIFICIO', '(100101) EDIFICIO'),
    ('QUINTA', '(100102) QUINTA'),
    ('CALLEJÓN', '(100103) CALLEJÓN'),
    ('CORRALÓN', '(100104) CORRALÓN'),
    ('SOLAR', '(100105) SOLAR'),
    ('CASA HABITACIÓN', '(100106) CASA HABITACIÓN'),
    ('CENTRO COMERCIAL', '(100201) CENTRO COMERCIAL'),
    ('GALERÍA', '(100202) GALERÍA'),
    ('OFICINA', '(100203) OFICINA'),
    ('OTRO NO ESPECIFICADO', '(100204) OTRO NO ESPECIFICADO'),
    ('MERCADO', '(100205) MERCADO'),
    ('INDUSTRIA', '(100301) INDUSTRIA'),
    ('RESIDENCIAL', '(100401) RESIDENCIAL'),
    ('COMERCIAL', '(100402) COMERCIAL'),
    ('NDUSTRIAL', '(100403) NDUSTRIAL'),
)
...
T_CATEGORIA_INMUEBLE = (
    ('PATRIMONIO MUNDIAL', '(01) PATRIMONIO MUNDIAL'),
    ('ZONA ARQUIOLÓGICA MONUMENTAL', '(02) ZONA ARQUIOLÓGICA MONUMENTAL'),
    ('SITIO ARQUIOLÓGICO', '(03) SITIO ARQUIOLÓGICO'),
    ('ZONA DE RESERVA ARQUIOLÓGICA', '(04) ZONA DE RESERVA ARQUIOLÓGICA'),
    ('ELEMENTO ARQUIOLÓGICO AISLADO', '(05) ELEMENTO ARQUIOLÓGICO AISLADO'),
    ('PAISAJE CULTURAL ARQUIOLÓGICO', '(06) PAISAJE CULTURAL ARQUIOLÓGICO'),
)
T_UNIDAD_MEDIDA = (
    ('M2', 'M2'),
    ('HAS', 'HAS'),
)
T_FILIACION_CRONOLOGICA = (
    ('PRECERÁMICO', '(01) PRECERÁMICO'),
...
T_PRESENCIA_NORMAL = (
    ('MAP', 'MONUMENTO ARQUEOLOGICO PREHISPANO'),
    ('MHCR', 'MONUMENTO HISTORICO COLONIAL/REPUBLICANO'),
)
T_ARQUITECTURA = (
    ('CIVIL PÚBLICA', '(01) CIVIL PÚBLICA'),
    ('CIVIL DOMÉSTICA', '(02) CIVIL DOMÉSTICA'),
    ('RELIGIOSA', '(03) RELIGIOSA'),
    ('MILITAR', '(04) MILITAR'),
...
T_FILIACION_ESTILISTICA = (
    ('GÓTICO', '(01) GÓTICO'),
    ('MUDÉJAR', '(02) MUDÉJAR'),
    ('PLATERESCO', '(03) PLATERESCO'),
    ('RENACENTISTA', '(04) RENACENTISTA'),
    ('MANIERISTABARROCO', '(05) MANIERISTABARROCO'),
    ('ROCOCO', '(06) ROCOCO'),
    ('NEOCLÁSICO', '(07) NEOCLÁSICO'),
    ('NEORENACENTISTA', '(08) NEORENACENTISTA'),
    ('ACADEMICISTA', '(09) ACADEMICISTA'),
    ('ART NOUVEAU', '(010) ART NOUVEAU'),
    ('NEOCOLONIAL', '(011) NEOCOLONIAL'),
    ('NEOPERUANO', '(012) NEOPERUANO'),
    ('INDIGENISTA', '(013) INDIGENISTA'),
...
T_INTERVENCION_INMUEBLE = (
    ('AMPLIACIÓN', '(01) AMPLIACIÓN'),
    ('ANASTILOSIS', '(02) ANASTILOSIS'),
    ('CONSERVACIÓN', '(03) CONSERVACIÓN'),
    ('CONSOLIDACIÓN', '(04) CONSOLIDACIÓN'),
    ('CONSTRUCCIÓN', '(05) CONSTRUCCIÓN'),
    ('DEMOLICIÓN', '(06) DEMOLICIÓN'),
    ('RENOVACIÓN/REVITALIZACIÓN URBANA', '(07) RENOVACIÓN/REVITALIZACIÓN URBANA'),
    ('PROTECCIÓN', '(08) PROTECCIÓN'),
    ('PUESTA EN VALOR', '(09) PUESTA EN VALOR'),
    ('REFACCIÓN', '(010) REFACCIÓN'),
    ('REMODELACIÓN', '(011) REMODELACIÓN'),
    ('OBRA NUEVA', '(012) OBRA NUEVA'),
    ('RESTAURACIÓN', '(013) RESTAURACIÓN'),
)
T_USO_RURAL = (
    ('TERRENO DE CULTIVO', '(01) TERRENO DE CULTIVO'),
...
T_CLASIFICACION_USO_ACTUAL = (
    ('AGRÍCOLA', '(01) AGRÍCOLA'),
    ('GANADERA', '(02) GANADERA'),
    ('AVÍCOLAFORESTAL', '(03) AVÍCOLAFORESTAL'),
    ('AGRO-INDUSTRIAL', '(04) AGRO-INDUSTRIAL'),
)
T_CONSTRUCCION_INSTALACION = (
    ('DEPÓSITO', '(01) DEPÓSITO'),
    ('RANCHERÍA', '(02) RANCHERÍA'),
    ('ESTABLO', '(03) ESTABLO'),
    ('CORRAL', '(04) CORRAL'),
    ('SILO', '(05) SILO'),
    ('GALPON DE AVES', '(06) GALPON DE AVES'),
    ('INVERNADERO', '(07) INVERNADERO'),
    ('POZO', '(08) POZO'),
...
T_DOCUMENTO_ACREDITA_RURAL = (
    ('PROPIEDAD', (
        ('TITULO DE PROPIEDAD.', '(01) TITULO DE PROPIEDAD.'),
        ('CONTRATO DE OTORGAMIENTO DE TERRENOS RÚSTICOS.', '(02) CONTRATO DE OTORGAMIENTO DE TERRENOS RÚSTICOS.'),
        ...
        ('CONTRATO OTORGADO DE ACUERDO A LA LEY NO 15037.', '(05) CONTRATO OTORGADO DE ACUERDO A LA LEY NO 15037.'),
        ...
        ('DECLARATORIA DE HEREDEROS', '(12) DECLARATORIA DE HEREDEROS, CON RESOLUCIÓN JUDICIAL CONSENTIDA.'),
...
T_OPERADOR_TELEFONO = (('AMERICATEL', 'AMERICATEL'), ('BITEL', 'BITEL'), ('CLARO', 'CLARO'), ('ENTEL', 'ENTEL'),
                       ('MOVISTAR', 'MOVISTAR'), ('OTRO', 'OTRO'))
T_SELECTOR_PERSONA = (
    ('TITULAR', 'EXISTE CATASTRAL TITULAR'),
